...
print("words == 22")
print("who")
print("now i want to know the word length.")
#so len function is used.
#first we choose a variable and put a variale in it.
mohit = "mohit _rajat@316"
print(mohit)
rajat = ("this is the length of the value stored inside the variable named mohit = " + str(len(mohit)))
print(rajat)
